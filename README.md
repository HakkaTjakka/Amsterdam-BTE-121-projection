...
***
https://www.youtube.com/watch?v=2zm-cQz_fbU
...
***
Area:
LAT: NORTH=52.6409912109375 SOUTH=52.09442138671875 LON: WEST=4,658203125 EAST=5,1251220703125
***
...
(need to adapt the sample .bat file for adding one extra floor y=-1 to -256 incl., add largest world-floor as last so you don't have to relocate)


Manual to replicate proces: https://github.com/HakkaTjakka/MinecraftWorldEditor/blob/master/manual.txt (English)

In Dutch: https://github.com/HakkaTjakka/MinecraftWorldEditor/blob/master/handleiding.txt
...
And many more for all the code.
